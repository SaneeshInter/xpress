          ...
          children: [
            Stack(children: [
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                if (null != items.hospitalAddress)
                  SizedBox(
                    width: 100.w,
                    child: Text(
                      items.hospitalAddress!,
                      maxLines: 2,

                      style: TextStyle(fontSize: 8.sp, color: Colors.blue, fontWeight: FontWeight.normal),textAlign: TextAlign.justify,overflow: TextOverflow.clip,
                    ),
                  ),
                SizedBox(height: screenHeight(context, dividedBy: 120)),
                Text(
                ...
                SizedBox(height: screenHeight(context, dividedBy: 120)),
                (items.timeFrom.toString().isEmpty && items.timeTo.toString().isEmpty)
                    ? const Text("")
                    : Text(
                        Txt.from + convert24hrTo12hr(items.timeFrom.toString().trim()) + Txt.to + convert24hrTo12hr(items.timeTo.toString().trim()),
                        style: const TextStyle(fontSize: 13, color: Colors.grey, fontWeight: FontWeight.w400),
                      ),
                SizedBox(height: screenHeight(context, dividedBy: 120)),
                if (null != items.type)
    ...
    children: [
      ...
      Row(
        ...
        children: [
          ...
          if (null != items.price && items.type == "Premium")
            Text(
              "\€${items.price}",
      ...
      SizedBox(height: screenHeight(context, dividedBy: 70)),
            ...
            Row(
              children: [
                ...
                // ),
                GestureDetector(
                    onTap: () => dialCall(Txt.contactNumber),
                    child: Image.asset(
                      "assets/images/icon/callgif.gif",
                      width: 45,
                      height: 45,
                    )),
                GestureDetector(
                    onTap: () => whatsappCall(),
                    child: Image.asset(
                      "assets/images/icon/whatsapp.gif",
                      width: 40,
                      height: 40,
                    )),
              ],
